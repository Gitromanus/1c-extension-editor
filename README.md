...
## Статическая сборка (для хостинга без Node, например «Бигет»)
...
### Деплой на «Бигет» (виртуальный хостинг, без VPS)

1. В панели «Бигета» откройте сайт → **Файловый менеджер / FTP** → папка `public_html`.
